...
public class BlockSculkDeepslate extends Block implements IGrowable {
	...
	public void registerBlockIcons(IIconRegister registry) {
		...
		this.sideIcon = registry.registerIcon("nova_craft:sculk_deepslate");
	}
	...
	public IIcon getIcon(IBlockAccess world, int x, int y, int z, int side) {
		if (side == 1) {
			...
			return OtherModBlocks.deepslate.getBlockTextureFromSide(side);
		} else {
	...
	public IIcon getIcon(int side, int meta) {
		...
		if (side == 0) return OtherModBlocks.deepslate.getBlockTextureFromSide(side);
		return sideIcon;
	}
