	...
	public static Item.ToolMaterial SCULK_HORN;
	 ...
	 static {		 
		   if (Configs.enableWeaponsToAllignWithVanilla == true) {
		    ...
		    NCToolMaterial.OPHIDIAN = EnumHelper.addToolMaterial("OPHIDIAN", 15, 8822, 23.0f, 2.5f, 22);
		    NCToolMaterial.REINFORCED_PHERITHIUM_SHICKAXE = EnumHelper.addToolMaterial("REINFORCED_PHERITHIUM_SHICKAXE", 15, 8322, 34.0f, 3.0f, 18);
	     	NCToolMaterial.CRYSTALLIZED_VANITE = EnumHelper.addToolMaterial("CRYSTALLIZED_VANITE", 15, 8822, 19.0f, 3.0f, 20);
	     	NCToolMaterial.KYLAZITE = EnumHelper.addToolMaterial("KYLAZITE", 13, 6822, 17.0f, 3.0f, 22);
	     	NCToolMaterial.KLANGITE = EnumHelper.addToolMaterial("KLANGITE", 15, 10822, 18.0f, 3.0f, 20);
	     	NCToolMaterial.WARDEN = EnumHelper.addToolMaterial("WARDEN", 15, 16822, 18.0f, 4.0f, 20);
		 	...
		 	NCToolMaterial.KYLAZITE_SWORD = EnumHelper.addToolMaterial("KYLAZITE_SWORD", 0, 6822, 0.0f, 7.0f, 22);	
		 
		 	NCToolMaterial.WARDEN_SWORD = EnumHelper.addToolMaterial("WARDEN_SWORD", 0, 16822, 0.0f, 7.0f, 20);	 
