...
public class ItemDiskNegative1 extends ItemRecord
{
    public final String recordName;
    private static final Map records;
    
    public ItemDiskNegative1(final String recordName) {
        super(recordName);
        this.recordName = recordName;
        ItemDiskNegative1.records.put(recordName, this);
        this.maxStackSize = 1;
    ...
    public static ItemDiskNegative1 getRecord(final String par0Str) {
        return (ItemDiskNegative1) ItemDiskNegative1.records.get(par0Str);
    }
    
    public ResourceLocation getRecordResource(final String name) {
        return new ResourceLocation("nova_craft:-1.record");
    }
