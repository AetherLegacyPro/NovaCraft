...
public class ItemDiskNegative2 extends ItemRecord
{
    public final String recordName;
    private static final Map records;
    
    public ItemDiskNegative2(final String recordName) {
        super(recordName);
        this.recordName = recordName;
        ItemDiskNegative2.records.put(recordName, this);
        this.maxStackSize = 1;
    ...
    public static ItemDiskNegative2 getRecord(final String par0Str) {
    	return (ItemDiskNegative2) ItemDiskNegative2.records.get(par0Str);
    }
    
    public ResourceLocation getRecordResource(final String name) {
        return new ResourceLocation("nova_craft:-2.record");
    }
