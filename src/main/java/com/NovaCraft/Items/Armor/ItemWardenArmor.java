...
public class ItemWardenArmor extends ItemBaseWardenArmor implements ISpecialArmor {

	//private final int[][] damageReductionAmountArray = new int[][]{new int[]{2, 3, 4, 2}, new int[]{2, 6, 5, 3}, new int[]{2, 6, 6, 3}, new int[]{3, 6, 8, 3}, new int[]{4, 8, 10, 4}};
	...
	public ItemWardenArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.warden_helmet);
        }
        if (chest != null) {
            hasPherithiumChest = (chest.getItem() == NovaCraftItems.warden_chestplate);
        }
        if (legs != null) {
            hasPherithiumLegs = (legs.getItem() == NovaCraftItems.warden_leggings);
        }
        if (boots != null) {
            hasPherithiumBoots = (boots.getItem() == NovaCraftItems.warden_boots);
        }
