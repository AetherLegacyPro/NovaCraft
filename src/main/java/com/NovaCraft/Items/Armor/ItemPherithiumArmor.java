...
public class ItemPherithiumArmor extends ItemBasePherithiumArmor implements ISpecialArmor {
	...
	public ItemPherithiumArmor(int armorType, ArmorMaterial material, String name, Item repair) {
