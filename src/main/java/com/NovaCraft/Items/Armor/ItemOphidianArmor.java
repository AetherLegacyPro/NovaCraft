...
public class ItemOphidianArmor extends ItemBaseOphidianArmor implements ISpecialArmor {
	...
	public ItemOphidianArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.ophidian_helmet);
        }
        if (chest != null) {
            hasPherithiumChest = (chest.getItem() == NovaCraftItems.ophidian_chestplate);
        }
        if (legs != null) {
            hasPherithiumLegs = (legs.getItem() == NovaCraftItems.ophidian_leggings);
        }
        if (boots != null) {
            hasPherithiumBoots = (boots.getItem() == NovaCraftItems.ophidian_boots);
        }
