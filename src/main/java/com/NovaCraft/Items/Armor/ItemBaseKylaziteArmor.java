...
public class ItemBaseKylaziteArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/kylazite_layer_1.png", "nova_craft:textures/armor/kylazite_layer_2.png"};
	...
	public ItemBaseKylaziteArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseKylaziteArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
