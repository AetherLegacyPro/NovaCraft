...
public class ItemBaseWardenArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/warden_layer_1.png", "nova_craft:textures/armor/warden_layer_2.png"};
	...
	public ItemBaseWardenArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseWardenArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
