...
public class ItemVaniteNotchedCrown extends ItemBaseVaniteNotchedCrown implements ISpecialArmor {
	...
	public ItemVaniteNotchedCrown(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.vanite_notched_crown);
        }
