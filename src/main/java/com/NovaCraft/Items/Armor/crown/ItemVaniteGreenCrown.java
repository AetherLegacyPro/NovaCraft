...
public class ItemVaniteGreenCrown extends ItemBaseVaniteGreenCrown implements ISpecialArmor {
	...
	public ItemVaniteGreenCrown(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.vanite_green_crown);
        }
