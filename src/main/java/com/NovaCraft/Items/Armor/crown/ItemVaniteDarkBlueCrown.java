...
public class ItemVaniteDarkBlueCrown extends ItemBaseVaniteDarkBlueCrown implements ISpecialArmor {
	...
	public ItemVaniteDarkBlueCrown(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.vanite_dark_blue_crown);
        }
