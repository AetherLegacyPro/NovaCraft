...
public class ItemVaniteRedCrown extends ItemBaseVaniteRedCrown implements ISpecialArmor {
	...
	public ItemVaniteRedCrown(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.vanite_red_crown);
        }
