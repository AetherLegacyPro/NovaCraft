...
public class ItemVaniteMysteriousCrown extends ItemBaseVaniteMysteriousCrown implements ISpecialArmor {
	...
	public ItemVaniteMysteriousCrown(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public void onArmorTick(final World world, final EntityPlayer player, final ItemStack itemStack) {
        ...
        if (helmet != null) {
            hasPherithiumHelmet = (helmet.getItem() == NovaCraftItems.vanite_mysterious_crown);
        }
