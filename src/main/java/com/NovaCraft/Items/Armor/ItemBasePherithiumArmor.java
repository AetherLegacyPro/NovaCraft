...
public class ItemBasePherithiumArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/pherithium_layer_1.png", "nova_craft:textures/armor/pherithium_layer_2.png"};
	...
	public ItemBasePherithiumArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBasePherithiumArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
