...
public class ItemBaseTophiniteArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/tophinite_layer_1.png", "nova_craft:textures/armor/tophinite_layer_2.png"};
	...
	public ItemBaseTophiniteArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseTophiniteArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
