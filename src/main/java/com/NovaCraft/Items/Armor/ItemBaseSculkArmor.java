...
public class ItemBaseSculkArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/sculk_layer_1.png", "nova_craft:textures/armor/sculk_layer_2.png"};
	...
	public ItemBaseSculkArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseSculkArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
