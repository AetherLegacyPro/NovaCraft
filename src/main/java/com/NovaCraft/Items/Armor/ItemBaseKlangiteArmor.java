...
public class ItemBaseKlangiteArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/klangite_layer_1.png", "nova_craft:textures/armor/klangite_layer_2.png"};
	...
	public ItemBaseKlangiteArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseKlangiteArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
