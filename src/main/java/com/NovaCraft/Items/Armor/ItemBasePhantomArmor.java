...
public class ItemBasePhantomArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/phantom_layer_1.png", "nova_craft:textures/armor/phantom_layer_2.png"};
	...
	public ItemBasePhantomArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBasePhantomArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
