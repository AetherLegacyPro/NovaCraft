...
public class ItemBaseOphidianArmor extends ItemArmor {

	private String[] defualt_location = new String[]{"nova_craft:textures/armor/ophidian_layer_1.png", "nova_craft:textures/armor/ophidian_layer_2.png"};
	...
	public ItemBaseOphidianArmor(int armorType, ArmorMaterial material, String name, Item repair) {
	...
	public ItemBaseOphidianArmor(int armorType, ArmorMaterial material, String name, Item repair, int hex) {
