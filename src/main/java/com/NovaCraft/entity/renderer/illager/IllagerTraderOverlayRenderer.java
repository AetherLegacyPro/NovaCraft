...
public class IllagerTraderOverlayRenderer extends IllagerTraderRenderer {
	...
	public ResourceLocation texture = new ResourceLocation("nova_craft", "textures/entity/vindicator_settler/cultist_overlay.png");
	public ModelBiped tutModel;
	
	public IllagerTraderOverlayRenderer() {
		super();
		this.mainModel = new IllagerTraderModel();
		this.modelBipedMain = (IllagerTraderModel) this.mainModel;
