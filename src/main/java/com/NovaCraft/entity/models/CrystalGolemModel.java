...
public class CrystalGolemModel extends ModelBase
{
    ...
    public CrystalGolemModel(float p_i1161_1_)
    {
        this(p_i1161_1_, -7.0F);
    }

    public CrystalGolemModel(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
    ...
    {
    	EntityCrystalGolem entityirongolem = (EntityCrystalGolem)p_78086_1_;
