...
public class IceologerModel extends ModelBiped {
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity)
    {
        ...
        if (entity instanceof EntityIceologer) {
            EntityIceologer vindicator = (EntityIceologer) entity;
        ...
        if (entity instanceof EntityCorruptist) {
            EntityCorruptist vindicator2 = (EntityCorruptist) entity;

            if (vindicator2.isAngry()) {
                this.bipedRightArm.rotateAngleX = -1.5F;
                this.bipedRightArm.rotateAngleY = 0.0F;
                this.bipedRightArm.rotateAngleZ = 0.0F;
            } else {
