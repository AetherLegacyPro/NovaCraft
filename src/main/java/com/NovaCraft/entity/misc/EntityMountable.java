...
import com.NovaCraft.PlayerNovaCraft;
...
public abstract class EntityMountable extends EntityNovaCraftAnimal {
	...
	public void updateRider() {
		if (this.canDismount() && this.riddenByEntity instanceof EntityPlayer) {
			PlayerNovaCraft playerAether = PlayerNovaCraft.get((EntityPlayer) this.riddenByEntity);
	...
	public void moveEntityWithHeading(float par1, float par2) {
		...
		if (entity instanceof EntityPlayer) {
			...
			if (PlayerNovaCraft.get(player).isJumping()) {
