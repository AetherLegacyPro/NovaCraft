...
@Mod(modid = NovaCraft.MOD_ID, version = "1.3.4", name = "NovaCraft")
public class NovaCraft
{
    ...
    public void preInit(final FMLPreInitializationEvent event) {
        ...
        event.getModMetadata().name = EnumChatFormatting.DARK_AQUA + "NovaCraft"+ EnumChatFormatting.DARK_PURPLE; //+ EnumChatFormatting.BOLD + "Release"
        event.getModMetadata().version = EnumChatFormatting.BLUE + "1.3.4";
