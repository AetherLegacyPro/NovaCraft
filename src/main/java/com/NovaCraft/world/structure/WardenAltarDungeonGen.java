...
public class WardenAltarDungeonGen extends WorldGenerator {
	...
	public boolean generate(World world, Random random, int x, int y, int z) {
		final float size = (6) + random.nextFloat(); //random.nextInt(0) +
...
//		}
            ...
            for (int j = -sizeInt; j <= sizeInt; j++) {
                for (int k = -sizeInt; k <= sizeInt; k++) {
                    ...
                    if (distSq <= DISTANCE_INNER_SQ) {
                        ...
                        world.setBlock(x + i, y + j, z + k, NovaCraftBlocks.sculk_bricks, 0, 2);
        ...
        
        {
        	...
        	world.setBlock(x, y - 3, z, NovaCraftBlocks.grimstone_shrieker, 0, 2);
        	
        	world.setBlock(x, y + 1, z, NovaCraftBlocks.sculk_block, 0, 2);
        	world.setBlock(x, y + 2, z, NovaCraftBlocks.sculk_block, 0, 2);
        	
        	world.setBlock(x + 1, y - 4, z, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 1, y - 4, z, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x, y - 4, z - 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x, y - 4, z + 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x + 1, y - 4, z - 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x + 1, y - 4, z + 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 1, y - 4, z + 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 1, y - 4, z + 1, NovaCraftBlocks.sculk_bricks, 0, 2);
			
			world.setBlock(x + 2, y - 3, z + 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 2, y - 3, z - 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x + 2, y - 3, z - 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 2, y - 3, z + 2, NovaCraftBlocks.sculk_bricks, 0, 2);			
			world.setBlock(x + 2, y - 2, z + 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 2, y - 2, z - 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x + 2, y - 2, z - 2, NovaCraftBlocks.sculk_bricks, 0, 2);
			world.setBlock(x - 2, y - 2, z + 2, NovaCraftBlocks.sculk_bricks, 0, 2);
