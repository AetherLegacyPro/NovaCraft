...
public class VillageHouseMedium extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		//world.setBlock(i + 8, j + 1, k + 0, Nullstone, 0, 2);
		//world.setBlock(i + 8, j + 1, k + 1, Nullstone, 0, 2);
		//world.setBlock(i + 8, j + 1, k + 2, Nullstone, 0, 2);
		//world.setBlock(i + 8, j + 1, k + 3, Nullstone, 0, 2);
		//world.setBlock(i + 8, j + 1, k + 4, Nullstone, 0, 2);
