...
public class VillageFarm extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		world.setBlock(i + 1, j + 1, k + 1, crops, 4, 2);
		world.setBlock(i + 1, j + 1, k + 2, crops, 2, 2);
		world.setBlock(i + 1, j + 1, k + 3, crops, 3, 2);
		world.setBlock(i + 1, j + 1, k + 4, crops, 5, 2);
		world.setBlock(i + 1, j + 1, k + 5, crops, 6, 2);
		world.setBlock(i + 1, j + 1, k + 6, crops, 2, 2);
		...
		world.setBlock(i + 3, j + 0, k + 1, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 2, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 3, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 4, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 5, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 6, waterStill, 0, 2);
		world.setBlock(i + 3, j + 0, k + 7, waterStill, 0, 2);
		...
		world.setBlock(i + 4, j + 1, k + 5, crops, 2, 2);
		world.setBlock(i + 4, j + 1, k + 6, crops, 3, 2);
		world.setBlock(i + 4, j + 1, k + 7, crops, 4, 2);
		world.setBlock(i + 5, j + 1, k + 1, crops, 2, 2);
		world.setBlock(i + 5, j + 1, k + 2, crops, 5, 2);
		world.setBlock(i + 5, j + 1, k + 3, crops, 6, 2);
		world.setBlock(i + 5, j + 1, k + 4, crops, 2, 2);
		world.setBlock(i + 5, j + 1, k + 5, crops, 3, 2);
		world.setBlock(i + 5, j + 1, k + 6, crops, 2, 2);
		world.setBlock(i + 5, j + 1, k + 7, crops, 7, 2);
		world.setBlock(i + 7, j + 1, k + 1, crops, 3, 2);
		world.setBlock(i + 7, j + 1, k + 2, crops, 2, 2);
		world.setBlock(i + 7, j + 1, k + 3, crops, 7, 2);
		world.setBlock(i + 7, j + 1, k + 4, crops, 4, 2);
		world.setBlock(i + 7, j + 1, k + 5, crops, 2, 2);
		world.setBlock(i + 7, j + 1, k + 6, crops, 4, 2);
		world.setBlock(i + 7, j + 1, k + 7, crops, 5, 2);
		world.setBlock(i + 8, j + 1, k + 1, crops, 3, 2);
		world.setBlock(i + 8, j + 1, k + 2, crops, 7, 2);
		world.setBlock(i + 8, j + 1, k + 3, crops, 7, 2);
		world.setBlock(i + 8, j + 1, k + 4, crops, 4, 2);
		world.setBlock(i + 8, j + 1, k + 5, crops, 5, 2);
		world.setBlock(i + 8, j + 1, k + 6, crops, 3, 2);
		world.setBlock(i + 8, j + 1, k + 7, crops, 6, 2);
		world.setBlock(i + 9, j + 0, k + 1, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 2, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 3, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 4, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 5, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 6, waterStill, 0, 2);
		world.setBlock(i + 9, j + 0, k + 7, waterStill, 0, 2);
		...
		world.setBlock(i + 11, j + 1, k + 2, crops, 7, 2);
		world.setBlock(i + 11, j + 1, k + 3, potato, 5, 2);
		world.setBlock(i + 11, j + 1, k + 4, potato, 5, 2);
		world.setBlock(i + 11, j + 1, k + 5, crops, 5, 2);
		world.setBlock(i + 11, j + 1, k + 6, crops, 3, 2);
		world.setBlock(i + 11, j + 1, k + 7, crops, 7, 2);
