...
public class Configs {
    ...
    public static boolean enableCreeperAlterations;
    public static boolean enableEndermanAlterations;
    ...
    public static boolean enableOldCaveGeneration;
    ...
    public static void loadConfigs(File configFile) {
        ...
        enableCreeperAlterations = conf.getBoolean("enableCreeperAlterations", "Misc", true, "Enables Creeper explosion radius to be tied to it's HP.");
        enableEndermanAlterations = conf.getBoolean("enableEndermanAlterations", "Misc", true, "Enables Enderman to deal more damage and teleport more often.");
        ...
        gammaAlterations = (float)conf.get("Gamma Alterations | Range:-1 - 1", "Important Options", 0.20D).getDouble();
        ...
        enableOldCaveGeneration = conf.getBoolean("enableOldCaveGeneration", "Important Options", true, "Enables 1.6.4 Cave Generation; Caves are more common.");
