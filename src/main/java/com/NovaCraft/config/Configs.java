...
public class Configs
{
    ...
    public static void loadConfigs(File configFile)
    {
    	...
    	enableVanillaBiomeAlterations = conf.getBoolean("enableVanillaBiomeAlterations", catGeneration, true, "Enables height changes and randomness to Vanilla Biomes");
    	enableVanillaHillBiomeAlterations = conf.getBoolean("enableVanillaHillBiomeAlterations", catGeneration, true, "Enables hill subtype biome changes: ForestHills, TagiaHills etc");
    	enableVanillaMountainBiomeAlterations = conf.getBoolean("enableVanillaMountainBiomeAlterations", catGeneration, true, "Enables extreme hill biome changes: ExtremeHills, ExtremeHillsPlus etc");
    	enablePlainsBiomeAlterations = conf.getBoolean("enablePlainsBiomeAlterations", catGeneration, true, "Enables plains and ice plains to be flatter in generation.");
    	enableDesertBiomeAlterations = conf.getBoolean("enableDesertBiomeAlterations", catGeneration, true, "Enables deserts to be flatter in generation.");
    	enableBeachBiomeAlterations = conf.getBoolean("enableBeachBiomeAlterations", catGeneration, true, "Enables beach biomes to be more pronounce and taller along coastlines.");
    	enableWaterBiomeAlterations = conf.getBoolean("enableWaterBiomeAlterations", catGeneration, true, "Enables rivers, swamps, and oceans to be a bit deeper in world generation.");
    	enableMiscBiomeAlterations = conf.getBoolean("enableMiscBiomeAlterations", catGeneration, true, "Enables regular biomes to have a slightly higher average height and randomness.");
        ...
        enableRareOverworldKlangiteOre = conf.getBoolean("enableRareOverworldKlangiteOre", catGeneration, false, "Enables Klangite Ore to also generate in the Overworld.");
        enableRareOverworldTophiniteOre = conf.getBoolean("enableRareOverworldTophiniteOre", catGeneration, false, "Enables Tophinite Ore to also generate in the Overworld.");          
        ...
        enableSculkInfestedMineshaft = conf.getBoolean("enableSculkInfestedMineshaft", catGeneration, true, "Enables Sculk Infested Mineshafts generation.");
        ...
        enableDeepslateOreGeneration = conf.getBoolean("enableDeepslateOreGeneration", catEtFuturum, false, "Enables Vanite to generate within deepslate from Et Futurum Requiem instead within stone and has a deepslate texture to compensate for it.");
        ...
        enableEtFuturumIronNugget = conf.getBoolean("enableEtFuturumIronNugget", catEtFuturum, true, "Allows recipes and blocks from NovaCraft to use and drop iron nuggets.(DISABLE if you disabled netherite in Et Futurum Requiem)");
        ...
        enableDarkOakFenceInAncientCity = conf.getBoolean("enableDarkOakFenceInAncientCity", catAncientCity, true, "Do not use Dark Oak Fence from Et Futurum Requiem instead use regular Fences in The Ancient City.");
        enableCobbledDeepslateInAncientCity = conf.getBoolean("enableCobbledDeepslateInAncientCity", catAncientCity, true, "Do not use Cobbled Deepslate from Et Futurum Requiem instead use Cobbled Grimstone in The Ancient City.");
        enableDeepslateInAncientCity = conf.getBoolean("enableDeepslateInAncientCity", catAncientCity, true, "Do not use Deepslate from Et Futurum Requiem instead use Grimstone Blocks in The Ancient City.");
        enableDeepslateBricksInAncientCity = conf.getBoolean("enableDeepslateBricksInAncientCity", catAncientCity, true, "Do not use Deepslate Bricks and building blocks from Et Futurum Requiem instead use Grimstone Bricks in The Ancient City.");
        enableEtFuturumSoulLanternInAncientCity = conf.getBoolean("enableEtFuturumSoulLanternInAncientCity", catAncientCity, true, "Do not use Et Futurum Requiem soul lanterns and instead use the ones from Netherlicious, if those do not exist then there will be nothing.");
        enableEtFuturumSoulFireInAncientCity = conf.getBoolean("enableEtFuturumSoulFireInAncientCity", catAncientCity, true, "Do not use Et Futurum Requiem soul fire and instead use the ones from Netherlicious, if those do not exist then use Deepfire.");
        enableBlueIceInAncientCity = conf.getBoolean("enableBlueIceInAncientCity", catAncientCity, true, "Do not use Blue Ice from Et Futurum Requiem instead use Packed Ice in The Ancient City.");
        enableIronTrapdoorInAncientCity = conf.getBoolean("enableIronTrapdoorInAncientCity", catAncientCity, true, "Do not use Iron Trapdoor from Et Futurum Requiem instead use regular trapdoor in The Ancient City.");
        ...
        enableSpawnCreepyCube = conf.getBoolean("enableSpawnCreepyCube", catMobs, true, "Enables the Spawning of the Creepy Cube");
        enableSpawnCreaking = conf.getBoolean("enableSpawnCreaking", catMobs, true, "Enables the Spawning of the Creaking");
        enableSpawnCreakinginModdedBiomes = conf.getBoolean("enableSpawnCreakinginModdedBiomes", catMobs, true, "Enables the Spawning of the Creaking in Modded Biomes; will spawn all variants at random as it only works with vanilla biomes.");
        enableSpawnFrog = conf.getBoolean("enableSpawnFrog", catMobs, true, "Enables the Spawning of Frogs");
        enableSpawnFroginModdedBiomes = conf.getBoolean("enableSpawnFroginModdedBiomes", catMobs, true, "Enables the Spawning of the Frog in Modded Biomes; will spawn all variants at random as it only works with vanilla biomes.");
        ...
        enableUniqueLegendaryBeaconBeam = conf.getBoolean("enableUniqueLegendaryBeaconBeam", catMisc, false, "Enables a unique beacon beam for the legendary beacon.");
        enableWardenBlindness = conf.getBoolean("enableWardenBlindness", catMisc, true, "Enables the Warden Applying blindess to the player when within 5 Blocks: Note if False the Player will be given Slowness II Instead");
        enableWardenSlowness = conf.getBoolean("enableWardenSlowness", catMisc, true, "Enables the Warden Applying slowness II to the player when within 5 Blocks");
        enableWardenWeakness = conf.getBoolean("enableWardenWeakness", catMisc, false, "Enables the Warden Applying weakness I to the player when within 5 Blocks");
        gammaAlterations = (float) conf.get("Gamma Alterations | Range:-1 - 1", catMisc, 0.00F).getDouble();
        enableGammaAlterations = conf.getBoolean("enableGammaAlterations", catMisc, true, "Locks the gamma of the game to be whatever is set in gammaAlterations: -0.25 is 25% darker etc");
        enableDebugMode = conf.getBoolean("enableDebugMode", catMisc, false, "Enables log messages for location of structures generating or if a crash was prevented.");
